...
export const SUBTASK_SYSTEM_PROMPT = `
...
export const SUBTASK_TOOL_EXECUTION_USER_PROMPT = `
ユーザーの元の質問: {question}
回答のための計画: {plan}
サブタスク: {subtask}
...
export const SUBTASK_REFLECTION_USER_PROMPT = `
3.リフレクションを開始してください
`;

export const SUBTASK_RETRY_ANSWER_USER_PROMPT = `
1.ツール選択・実行をリフレクションの結果に従ってやり直してください
`;

export const CREATE_LAST_ANSWER_SYSTEM_PROMPT = `
...
export const CREATE_LAST_ANSWER_USER_PROMPT = `
ユーザーの質問: {question}
